...
class LogNormMixNet(RecurrentTPP):
    """
    ...
    Args:
        ...
        num_meta_classes: Number of meta classes
        mean_log_inter_time: Average log-inter-event-time, see dpp.data.dataset.get_inter_time_statistics
        std_log_inter_time: Std of log-inter-event-times, see dpp.data.dataset.get_inter_time_statistics
    ...
    def __init__(
        ...
        super().__init__(
            ...
            num_src_marks=num_src_marks,
            num_dst_marks=num_dst_marks,
        ...
        self.linear = nn.Linear(self.context_size + self.meta_embedding_size, 3 * self.num_mix_components)
